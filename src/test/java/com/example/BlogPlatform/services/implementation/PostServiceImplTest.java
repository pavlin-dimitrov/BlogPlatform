...
class PostServiceImplTest {
  ...
  void testGetAllByAccountId3() {
    ...
    post1.setDeletedAt(LocalDateTime.now());
    post1.setId(123L);
  ...
  void testGetAllByAccountId5() {
    ...
    doNothing().when(post).setCreatedAt((LocalDateTime) any());
    doNothing().when(post).setDeletedAt((LocalDateTime) any());
    ...
    verify(post).setCreatedAt((LocalDateTime) any());
    verify(post).setDeletedAt((LocalDateTime) any());
